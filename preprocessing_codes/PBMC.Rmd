...
samples <- list.files("/Users/joannazyprych/Documents/Zurich/single_cell/dane/CSF/input", pattern="CR05", full.names = TRUE)
without <- c(paste0("/Users/joannazyprych/Documents/Zurich/single_cell/dane/CSF/input", "/CR052"),paste0("/Users/joannazyprych/Documents/Zurich/single_cell/dane/CSF/input", "/CR059"))
...
# load metadata
# meta <- read_excel(paste0(data_path, "/", meta_dir))
meta <- read_excel(paste0("/Users/joannazyprych/Documents/Zurich/single_cell/dane/CSF/input", "/", meta_dir))
...
# Save data
saveRDS(sce, file = paste0(out_path, "/sce_pbmc.rds"))
saveRDS(seurat, file = paste0(out_path, "/seurat_pbmc.rds"))
